...
const contactData = {
  en: {
    ...
    titleHighlight: "Us",
    description: "Have a project in mind? Connect with our experts via WhatsApp or visit our official Facebook page.",
    contactBtn: "Contact with Me",
    fbTitle: "Facebook Page",
    fbDesc: "Stay updated with our latest works",
    visitBtn: "Visit Page",
    members: [
      {
        name: 'Injamamul Hoq',
  ...
  bn: {
    badge: "যোগাযোগ করুন",
    titlePart1: "আমাদের সাথে",
    titleHighlight: "যুক্ত হোন",
    description: "কোনো প্রজেক্ট নিয়ে ভাবছেন? হোয়াটসঅ্যাপের মাধ্যমে আমাদের এক্সপার্টদের সাথে যোগাযোগ করুন অথবা আমাদের অফিসিয়াল ফেসবুক পেজ ভিজিট করুন।",
    contactBtn: "যোগাযোগ করুন",
    fbTitle: "ফেসবুক পেজ",
    fbDesc: "আমাদের সর্বশেষ কাজগুলোর সাথে আপডেট থাকুন",
    visitBtn: "পেজ ভিজিট করুন",
    members: [
      {
        name: 'ইনজামামুল হক',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-slate-900/60 border border-slate-800/85 p-6 sm:p-8 rounded-2xl sm:rounded-3xl flex flex-col items-center text-center hover:border-slate-700 transition-all duration-300 shadow-xl group md:col-span-2 lg:col-span-1">
            ...
            {/* Title & Subtitle */}
            <h3 className="text-xl sm:text-2xl font-bold text-white mb-1">{t.fbTitle}</h3>
            <p className="text-xs sm:text-sm text-slate-400 mb-6">{t.fbDesc}</p>
